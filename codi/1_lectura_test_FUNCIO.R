...
#50 “items” repartidos en tres dimensiones
...
#Preguntas con 5 opciones de respuesta

#Puntuación de 0 a 100 (0 mejor calidad de vida posible-100 peor) 
...
SANT_GEORGES<-function(dt=dades2) {
  ...
  # explicació del nostre questionari: [SAINT GEORGE’S RESPIRATORY QUESTIONNAIRE] (SGRQ)
  #-------------------------------------------------------------------------#
  #Diseñado por PW Jones en 1991, para cuantificar el 
  #impacto de las enfermedades respiratorias, en el estado de
  #salud y el bienestar de pacientes respiratorios
  #-------------------------------------------------------------------------#
  
  #-------------------------------------------------------------------------#
  # PARTE1
  #-------------------------------------------------------------------------#
  ### SIMPTOMAS.seccio1:   sg1(1,2,3,4,5,9)-->   [PSG1]
  #                        sg2(1,2,3,4,5,9)-->   [PSG2]
  #                        sg3(1,2,3,4,5,9)-->   [PSG3]
  #                        sg4(1,2,3,4,5,9)-->   [PSG4]
  #                        sg5(1,2,3,4,5,9)-->   [PSG5]
  #                        sg6(1,2,3,4,5,9)-->   [PSG6]
  #                        sg7(1,2,3,4,5,9)-->   [PSG7]
  #                        sg8(1,2,8,9)-->       [PSG8]
  #-------------------------------------------------------------------------#
  #-------------------------------------------------------------------------#
  # PARTE2
  #-------------------------------------------------------------------------#
  ### IMAPCTO.seccio1:     sg9(1,2,3,4,9)-->    [PSG9] 
  #                        sg10(1,2,3,8,9)-->   [PSG10]
  #-------------------------------------------------------------------------#
  ### ACTIVITAT.seccio2:   sg111(0,1,9)-->  [PSG111,R111] 
  #                        sg112(0,1,9)-->  [PSG112,R112]
  #                        sg113(0,1,9)-->  [PSG113,R113]
  #                        sg114(0,1,9)-->  [PSG114,R114]
  #                        sg115(0,1,9)-->  [PSG115,R115]
  #                        sg116(0,1,9)-->  [PSG116,R116]
  #                        sg117(0,1,9)-->  [PSG117,R117]
  #-------------------------------------------------------------------------#
  ### IMAPCTO.seccio3:     sg121(0,1,9)-->  [PSG121,R121] 
  #                        sg122(0,1,9)-->  [PSG122,R122]
  #                        sg123(0,1,9)-->  [PSG123,R123]
  #                        sg124(0,1,9)-->  [PSG124,R124]
  #                        sg125(0,1,9)-->  [PSG125,R125]
  #                        sg126(0,1,9)-->  [PSG126,R126] 
  #-------------------------------------------------------------------------#
  ### IMPACTO.seccio4:     sg131(0,1,9)-->  [PSG131,R131] 
  #                        sg132(0,1,9)-->  [PSG132,R132] 
  #                        sg133(0,1,9)-->  [PSG133,R133] 
  #                        sg134(0,1,9)-->  [PSG134,R134] 
  #                        sg135(0,1,9)-->  [PSG135,R135] 
  #                        sg136(0,1,9)-->  [PSG136,R136] 
  #                        sg137(0,1,9)-->  [PSG137,R137] 
  #                        sg138(0,1,9)-->  [PSG138,R138]
  #-------------------------------------------------------------------------#
  ### IMPACTO.seccio5:     sg141(0,1,9)-->  [PSG141,R141] 
  #                        sg142(0,1,9)-->  [PSG142,R142] 
  #                        sg143(0,1,9)-->  [PSG143,R143] 
  #                        sg144(0,1,9)-->  [PSG144,R144]
  #-------------------------------------------------------------------------#
  ### ACTIVITAT.seccio6:   sg151(0,1,9)-->  [PSG151,R151] 
  #                        sg152(0,1,9)-->  [PSG152,R152] 
  #                        sg153(0,1,9)-->  [PSG153,R153] 
  #                        sg154(0,1,9)-->  [PSG154,R154] 
  #                        sg155(0,1,9)-->  [PSG155,R155] 
  #                        sg156(0,1,9)-->  [PSG156,R156]
  #                        sg157(0,1,9)-->  [PSG157,R157] 
  #                        sg158(0,1,9)-->  [PSG158,R158]  
  #                        sg159(0,1,9)-->  [PSG159,R159] 
  #-------------------------------------------------------------------------#
  ### IMPACTO.seccio7:     sg161(0,1,9)-->  [PSG161,R161] 
  #                        sg162(0,1,9)-->  [PSG162,R162] 
  #                        sg163(0,1,9)-->  [PSG163,R163] 
  #                        sg164(0,1,9)-->  [PSG164,R164] 
  #                        sg165(0,1,9)-->  [PSG165,R165]
  #-------------------------------------------------------------------------#
  ### IMPACTO.seccio8:     sg17(1,2,3,4,9)--->  [PSG17]
  #-------------------------------------------------------------------------#
  #Sintomatología, incluyendo tos, esputo, sibilancias,disnea
  #........EJEMPLOS:
  #-------------------------------------------------------------------------#
  #Durante el último año, ¿ha tenido tos?
  #1.-Casi todos los días de la semana
  #2.-Varios días a la semana
  #3.-Unos pocos días al mes
  #4.-Sólo cuando tuve infección en los pulmones
  #5.-Nada en absoluto 
  #-------------------------------------------------------------------------#
  #Actividad: actividad física limitada por la enfermedad [#si/no]
  #........EJEMPLOS
  #-------------------------------------------------------------------------#
  ...
  #Me falta la respiración al hacer deporte o al jugar
  #-------------------------------------------------------------------------#
  #Impacto: como afecta la enfermedad al trabajo, familia, necesidad de
  #medicación, efectos secundarios…[#si/no]
  #.....EJEMPLOS
  #-------------------------------------------------------------------------#
  #La tos o la respiración me dan vergüenza en público
  #Mis problemas respiratorios son una molestia para mi, mi familia,
  ...
  #-------------------------------------------------------------------------#
  #EL CUESTIONARIO COMPLETO DE SAINT GEORGO (CRSG) == CARPEETA Docs.
  #-------------------------------------------------------------------------#
...
#[1] "sg1"   "sg2"   "sg3"   "sg4"   "sg5"   "sg6"   "sg7"   "sg8"   "sg9"   "sg10"  "sg111" "sg112" "sg113"
#[14] "sg114" "sg115" "sg116" "sg117" "sg121" "sg122" "sg123" "sg124" "sg125" "sg126" "sg131" "sg132" "sg133"
#[27] "sg134" "sg135" "sg136" "sg137" "sg138" "sg141" "sg142" "sg143" "sg144" "sg151" "sg152" "sg153" "sg154"
#[40] "sg155" "sg156" "sg157" "sg158" "sg159" "sg161" "sg162" "sg163" "sg164" "sg165" "sg17" 
...
resu1 <- compareGroups( ~ SYMPTOM + ACTIVIT+IMPACTS+TOTALSG, data = RRR) 
resu2 <- compareGroups( ~ SYMPTOM + ACTIVIT+IMPACTS+TOTALSG, data = RRR,
                        method = c(SYMPTOM = 2,ACTIVIT=2,IMPACTS=2,TOTALSG=2 )) 
#--------------------------------------------------------------------------------------------#
createTable(resu1)
createTable(resu2)
#--------------------------------------------------------------------------------------------#
resu3<-RRR%>%select(SYMPTOM,ACTIVIT,IMPACTS,TOTALSG)
summary(resu3)
#--------------------------------------------------------------------------------------------#
#CORRELATIONS
#/VARIABLES= SYMPTOM ACTIVIT IMPACTS TOTALSG
...
#SYMPTOM 1.0000000 0.7619286 0.9134699 0.9270502
#ACTIVIT 0.7619286 1.0000000 0.8319625 0.9022310
#IMPACTS 0.9134699 0.8319625 1.0000000 0.9867935
#TOTALSG 0.9270502 0.9022310 0.9867935 1.0000000
#--------------------------------------------------------------------------------------------#
